...
using VPSAutomation.ObjectRepository;

namespace VPSAutomation
{
    public class TestCaseCodedActivity : System.Activities.Activity
    {
        public TestCaseCodedActivity()
        {
            this.Implementation = () =>
            {
                return new TestCaseCodedActivityChild()
                {};
            };
        }
    }

    internal class TestCaseCodedActivityChild : UiPath.CodedWorkflows.AsyncTaskCodedWorkflowActivity
    {
        public System.Collections.Generic.IDictionary<string, object> newResult { get; set; }

        public TestCaseCodedActivityChild()
        {
            DisplayName = "TestCaseCoded";
        }
        ...
        {
            var codedWorkflow = new global::VPSAutomation.TestCaseCoded();
            ...
            await System.Threading.Tasks.Task.Run(() => CodedWorkflowHelper.RunWithExceptionHandlingAsync(() =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "TestCaseCoded.cs"});
                }
            ...
            }, (exception, outArgs) =>
            {
                if (codedWorkflow is IBeforeAfterRun codedWorkflowWithBeforeAfter)
                {
                    ...
                    {RelativeFilePath = "TestCaseCoded.cs", Exception = exception});
                }
